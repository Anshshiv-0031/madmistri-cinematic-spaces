export function WhatsAppFab() {
  return (
    <a
      href="https://wa.me/919370476464?text=Hello%20Mad%20Mistri%2C%20I%27d%20like%20to%20discuss%20a%20project."
      target="_blank"
      rel="noreferrer"
      aria-label="Chat on WhatsApp"
      className="fixed bottom-6 right-6 z-40 group"
    >
      <span className="absolute inset-0 rounded-full bg-gold/40 blur-xl group-hover:bg-gold/60 transition-all duration-700" />
      <span className="relative flex items-center justify-center w-14 h-14 rounded-full bg-gold text-ink shadow-[0_10px_40px_-10px_rgba(199,166,106,0.6)] hover:scale-105 transition-transform duration-500">
